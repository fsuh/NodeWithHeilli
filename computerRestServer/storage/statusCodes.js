...
const MESSAGES = {
  ...
  NOT_FOUND: (key, value) => ({
    message: `No resource found with id ${key}${value}`,
    code: CODES.NOT_FOUND,
    type: "info",
  }),
  INSERT_OK: (key, value) => ({
    message: `Resource ${key}${value} was inserted`,
  ...
  NOT_REMOVED: (key, value) => ({
    message: `No resource found with key ${key}${value}. Nothing Removed`,
    code: CODES.NOT_REMOVED,
    type: "error",
  }),
  KEY_NO_NOT_MATCH: (key, keyInResource) => ({
    message: `The key ${key} of given resource  don't match the given key ${keyInResource}`,
